...
Pod::Spec.new do |s|
  s.name             = 'PageMenu'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PageMenu.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'Tim Johnson' => 'timj@kamcord.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/PageMenu.git', :tag => s.version.to_s }
